...
- O motor de render do picker é `profills-post/scripts/picker/picker-frame.html` (o servidor injeta o bloco `DADOS`); `profills-post/assets/preview-template.html` é a referência visual do card, mesmo motor em arquivo único. Mudança de UI vai nos dois; nunca reescrever o HTML.
