...
- `profills-post/scripts/picker/` (server.cjs, helper.js, start/stop-server.sh) deriva de [obra/superpowers](https://github.com/obra/superpowers) (MIT, Jesse Vincent) — licença em `scripts/picker/LICENSE-obra-superpowers`, cabeçalho de atribuição em cada arquivo derivado; manter ao sincronizar com o upstream.
