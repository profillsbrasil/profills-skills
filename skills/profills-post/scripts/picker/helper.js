(function() {
  ...
  function setStatus(state) {
    ...
    if (!el) return;
    const map = {
      connecting:   ['Conectando…',   'var(--text-tertiary)'],
      connected:    ['Conectado',     'var(--success)'],
      reconnecting: ['Reconectando…', 'var(--warning)'],
      disconnected: ['Desconectado',  'var(--error)']
    };
  ...
  function showTombstone() {
    ...
    el.innerHTML = '<div style="max-width:480px">' +
      '<h2 style="margin:0 0 .5rem;font-weight:600">Picker pausado</h2>' +
      '<p style="margin:0;opacity:.85">O picker de posts parou. ' +
      'Peça ao agente para religar. Esta página reconecta sozinha.</p></div>';
