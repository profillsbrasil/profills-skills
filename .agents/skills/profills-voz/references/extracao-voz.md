...
- **Palavras banidas** — termos que ele nunca usa (extraídos por ausência no material + rejeições na validação). É a lista que o quality gate da `profills-post` checa em todo rascunho. Prevenir é mais barato que corrigir: uma vez listada, a palavra não volta.
