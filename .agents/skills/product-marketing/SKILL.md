...
description: >-
  Cria e mantém o arquivo de voz do usuário (.agents/product-marketing.md) — o
  ...
  a linkedin-draft ou a linkedin-catalog não encontrarem o arquivo, ou quando o
...
- **Prova é número real do usuário.** "Muitos clientes" não entra; "40 clientes desde 2023" entra. Sem número confirmado, o campo fica com `[a confirmar]` — a `linkedin-draft` sabe pedir depois.
