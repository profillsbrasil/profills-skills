...
O slug vem da URL `linkedin.com/company/<slug>`. Ele pode mudar num rebranding; o ID numérico (5-9 dígitos) não. Se a `linkedin-refs` guardou o ID no dossiê e o slug falhar, tente pela URL com ID.
